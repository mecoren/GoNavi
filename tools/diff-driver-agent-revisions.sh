...
normalize_driver_name() {
  ...
  case "$value" in
    ...
    mariadb|oceanbase|starrocks|sphinx|sqlserver|sqlite|duckdb|dameng|kingbase|highgo|vastbase|opengauss|gaussdb|iris|mongodb|tdengine|iotdb|clickhouse|elasticsearch|trino)
      echo "$value"
      ;;
    *)
      return 1
